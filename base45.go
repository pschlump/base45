...
// 64-character alphabet. The most common encoding is the "base45"
...
// StdEncoding is the standard base45 encoding, as defined in
// RFC 4648.
var StdEncoding = NewEncoding(encodeStd)

// URLEncoding is the alternate base45 encoding defined in RFC 4648.
// It is typically used in URLs and file names.
var URLEncoding = NewEncoding(encodeURL)

// RawStdEncoding is the standard raw, unpadded base45 encoding,
// as defined in RFC 4648 section 3.2.
// This is the same as StdEncoding but omits padding characters.
var RawStdEncoding = StdEncoding.WithPadding(NoPadding)

// RawURLEncoding is the unpadded alternate base45 encoding defined in RFC 4648.
// It is typically used in URLs and file names.
...
// NewEncoder returns a new base45 stream encoder. Data written to
...
// decodeQuantum decodes up to 4 base45 bytes. The received parameters are
// the destination buffer dst, the source buffer src and an index in the
// source buffer si.
// It returns the number of bytes read from src, the number of bytes written
// to dst, and an error, if any.
func (enc *Encoding) decodeQuantum(dst, src []byte, si int) (nsi, n int, err error) {
	// Decode quantum using the base45 alphabet
	var dbuf [4]byte
	dlen := 4
...
// written. If src contains invalid base45 data, it will return the
...
// assemble32 assembles 4 base45 digits into 3 bytes.
...
// assemble64 assembles 8 base45 digits into 6 bytes.
// Each digit comes from the decode map, and will be 0xff
// if it came from an invalid character.
...
func (enc *Encoding) DecodedLen(n int) int {
	...
	// Padded base45 should always be a multiple of 4 characters in length.
	return n / 4 * 3
}
